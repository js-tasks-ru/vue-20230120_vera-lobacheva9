  ...
  <form class="meetup-form" @submit.prevent="submit">
    <div class="meetup-form__content">
      ...
      <MeetupAgendaItemForm
        v-for="(agendaItem, i) in localMeetup.agenda"
        :key="agendaItem.id"
        v-model:agenda-item="localMeetup.agenda[i]"
    ...
    <div class="meetup-form__aside">
      <div class="meetup-form__aside-stick">
        ...
        <ui-button variant="primary" block class="meetup-form__aside-button" data-test="submit" @click="submit">
          {{ submitText }}
        </ui-button>
      </div>
    </div>
