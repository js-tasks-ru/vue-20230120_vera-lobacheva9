      ...
      >
        ...
        <div class="calendar-view__cell-content">
          <slot
            ...
            :inactive="!item.isCurrentMonthDay"
          ></slot>
        </div>
      </div>
    </div>
    ...
    calendarDays() {
      ...
      for(let i = additionalPreviousMonthDays; i > 0; i--) {
        ...
        days.push({
          ...
          date: prevMonthDay,
          shortDate: this.shortDateFormat(prevMonthDay),
      ...
      for(let i = firstDayOfMonth.getDate(); i <= lastDayOfMonth.getDate(); i++) {
        ...
        days.push({
          day: i,
          date,
          shortDate: this.shortDateFormat(date),
      ...
      for(let i = 1; i <= additionalNextMonthDays; i++) {
        ...
        days.push({
          ...
          date: nextMonthDay,
          shortDate: this.shortDateFormat(nextMonthDay),
          currentMonthDay: false,
        });
      }
      return days;
